        ...
        <nav className="navbar navbar-expand-lg" style={{borderBottom:"1px solid #D6D5D5"}}>
            <div className="container">
                <Link to="/" className="navbar-brand">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-amazon" style={{color:"black"}} viewBox="0 0 16 16">
                ...
                <div className="offcanvas offcanvas-start d-block d-lg-none" tabIndex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                <div className="offcanvas-header">
                    <h3 className="offcanvas-title" id="offcanvasExampleLabel">Items</h3>
                    <button type="button" className="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <hr/>
                <div className="offcanvas-body d-block d-lg-none">
                ...
                <div className='profileIconCont' tabIndex="0">
                    <div className="dropdown">
                        <button className="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" tabIndex="0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi text-dark profileIcon" viewBox="0 0 16 16">
                ...
                <Link to="/wishlist" className='float-right cursor-pointer '>
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-heart text-dark me-4" viewBox="0 0 16 16">
                ...
                <Link to="/cart" className='float-right cursor-pointer cartIcon'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-cart3 headerCartIcon" style={{color:"black"}} viewBox="0 0 16 16">
