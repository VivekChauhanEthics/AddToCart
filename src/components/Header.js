    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg bg-primary">
            <div className="container">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-amazon" style={{color:"white"}} viewBox="0 0 16 16">
                ...
                <div className="collapse navbar-collapse d-flex d-none d-lg-block" id="navbarSupportedContent" style={{ justifyContent: "center" }}>
                    <ul className="navbar-nav mb-2 mb-lg-0 gap-lg-4 d-lg-flex">
                        <li className="nav-item">
                            <Link to="/" className={`nav-link  ${location.pathname === '/' ? 'active' : 'text-white HeaderNavItem'}`} aria-current="page">Home</Link>
                        </li>
                        <li className='nav-item'>
                            <Link to="/about" className={`nav-link ${location.pathname === '/about' ? 'active' : 'text-white HeaderNavItem'}`}>About</Link>
                        </li>
                        <li className='nav-item'>
                            <Link to="/contact" className={`nav-link  ${location.pathname === '/contact' ? 'active' : 'text-white HeaderNavItem'}`} >Contact</Link>
                        </li>
                        <li className='nav-item'>
                            <Link to="/blog" className={`nav-link  ${location.pathname === '/blog' ? 'active' : 'text-white HeaderNavItem'}`}>Blog</Link>
                        </li>
                    </ul>
                </div>
                ...
                <ul className="navbar-nav mb-2 mb-lg-0 gap-lg-4 ">
                        ...
                        <hr/>
                        <li className='nav-item'>
                            <Link to="/blog" className={`nav-link  ${location.pathname === '/blog' ? 'active' : 'text-dark'}`}>Blog</Link>
                        </li>
                        <hr/>
                    </ul>
                </div>
                ...
                <div className='profileIconCont'>
                    <div class="dropdown">
                        <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi text-white profileIcon" viewBox="0 0 16 16">
                ...
                <Link to="/cart"> <div className='Cartstyle'><span>{cart.length}</span></div></Link>
                <Link to="/cart" className='float-right cursor-pointer cartIcon'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-cart3 headerCartIcon" style={{color:"white"}} viewBox="0 0 16 16">
