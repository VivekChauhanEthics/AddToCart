                ...
                <div className="container">
                    ...
                    <div className='headerIconsCont'>
                        ...
                        <Link to="/wishlist" className='float-right WishlistCountCont cursor-pointer'>
                            ...
                            <div className='WishlistCountstyle'><span>{wishlist.length}</span></div>
                        </Link>
